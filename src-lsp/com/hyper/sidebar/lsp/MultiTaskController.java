...
public final class MultiTaskController {
    ...
    public void openAppInMain(final ComponentName component) {
        ...
        final boolean homeVisible = TaskResizer.isHomeVisibleOnDefaultDisplay(context);
        ...
        if (!homeVisible && component.equals(currentComponent)) return;

        mBusy = true;
        try {
            if (!homeVisible && currentTaskId != null && emptySlot >= 0) {
