...
public class AppItem extends SidebarItem {
    ...
    public Drawable getAvatar() {
        ...
        if (ri != null) {
            ...
            ret = ri.loadIcon(packageManager);
            if (ret == null || isDefaultPlaceholder(ret, packageManager)) {
                return null;
            }
    ...
    private boolean isDefaultPlaceholder(Drawable drawable, PackageManager packageManager) {
        try {
            ...
            // Treat an icon as usable when the platform cannot expose its constant state.
        }
        return false;
    }
