...
public class AddContactManager extends DataManager {
    ...
    private View.OnClickListener mMmsListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.setComponent(new ComponentName("com.hyper.sidebar", "com.hyper.sidebar.SelectContactActivity"));
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            try{
                Utils.dismissAllDialog(mContext);
                mContext.startActivity(intent);
    ...
    private View.OnClickListener mMailListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent();
            intent.setComponent(new ComponentName("com.hyper.sidebar", "com.hyper.sidebar.SelectMailContactActivity"));
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            try{
                Utils.dismissAllDialog(mContext);
                mContext.startActivity(intent);
