...
import com.hyper.sidebar.SidebarMode;
import com.hyper.sidebar.SidebarStatus;
import com.hyper.sidebar.lsp.LSPLogger;
import com.hyper.sidebar.util.AppItem;
import com.hyper.sidebar.util.ContactItem;
import com.hyper.sidebar.util.ContactManager;
import com.hyper.sidebar.util.DingDingContact;
import com.hyper.sidebar.util.DragHapticFeedback;
import com.hyper.sidebar.util.LOG;
import com.hyper.sidebar.util.MailContact;
import com.hyper.sidebar.util.MmsContact;
import com.hyper.sidebar.util.Tracker;
import com.hyper.sidebar.util.Utils;
import com.hyper.sidebar.util.WechatContact;
